...
exports.editarTopico = exports.eliminarTopico = exports.listarTopicosPorModulo = exports.crearTopico = void 0;
...
// --------------------- Crear tópico ---------------------
const crearTopico = async (req, res) => {
    const { titulo, descripcion, tipo, disponible_desde, disponible_hasta, id_modulo, id_curso, } = req.body;
    ...
    try {
        ...
        const disponibleDesde = disponible_desde ? new Date(disponible_desde) : null;
        const disponibleHasta = disponible_hasta ? new Date(disponible_hasta) : null;
        // Crear tópico
...
const listarTopicosPorModulo = async (req, res) => {
...
exports.listarTopicosPorModulo = listarTopicosPorModulo;
const eliminarTopico = async (req, res) => {
...
exports.eliminarTopico = eliminarTopico;
const editarTopico = async (req, res) => {
    const { idTopico } = req.params;
    const { titulo, descripcion, disponible_desde, disponible_hasta, } = req.body;
    if (!idTopico) {
...
exports.editarTopico = editarTopico;
