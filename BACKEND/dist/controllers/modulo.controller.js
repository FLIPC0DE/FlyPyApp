...
exports.editarModulo = exports.eliminarModulo = exports.obtenerModulosPorCurso = exports.crearModulo = void 0;
...
const obtenerModulosPorCurso = async (req, res) => {
    try {
...
exports.obtenerModulosPorCurso = obtenerModulosPorCurso;
...
const editarModulo = async (req, res) => {
    try {
        const { idModulo } = req.params;
