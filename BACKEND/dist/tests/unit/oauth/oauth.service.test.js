...
describe("oauth.service.ts", () => {
    it("genera URL de redirección para Google", () => {
        ...
        const url = (0, oauth_service_1.getOAuthRedirectUrl)("google");
    ...
    it("genera URL de redirección para Microsoft", () => {
        ...
        const url = (0, oauth_service_1.getOAuthRedirectUrl)("microsoft");
    ...
    it("genera URL de redirección para GitHub", () => {
        ...
        const url = (0, oauth_service_1.getOAuthRedirectUrl)("github");
